...
<html>
  <head>
	...
	-->
	<link rel="stylesheet" type="text/css" href="./css/GroupUIStyle.css">
  </head>
  <body>
   <% 
		...
		String sql = "SELECT [ContactIcon],[RelateID],[RContact],[RGroup],[ContactID],[ContactName],[ContactWork],[ContactTel],[ContactEmail],[ContactUser],[sex] FROM [AddressBook].[dbo].[Contact] as  C join [AddressBook].[dbo].[Relate] AS R on R.RContact = C.ContactID where RGroup = '"+GroupID+"'";
    					...
    					<div id="ContactMessageDiv">
        					...
        					<%while(rs.next()) {%>
         	 					<li id="ContactLi">
         	   						...
         	   						<p id="ContactIDp"><a href="jsp/ContactMsgUI.jsp?ContactID=<%=rs.getString("ContactID") %>&GroupID=<%=GroupID%>"><%=rs.getString("ContactName") %></a></p>
         	   						<a href="jsp/DeleteContact.jsp?ContactID=<%=rs.getString("ContactID")%>&GroupID=<%=GroupID%>"><img src="./img/delete_dustbin_garbage_recycle_bin_trash_can_24px_1225501_easyicon.net.png" class="right DelContact"></a>
  				...
  				<div class="left RHLDiv">
  					<ul id="RHLUl">	
						...
						<div id="fade" class="black_overlay"></div>
  						...
  						<li class="left" id="RHLli"><a href="jsp/GroupDel.jsp?GroupID=<%=GroupID%>">删除此组</a></li>
